...
class Grant(db.Model, ModelWithUpsert):
    ...
    recipientOrganization_charityNumber = db.Column(db.String, index=True)
    recipientOrganization_companyNumber = db.Column(db.String, index=True)
    ...
    geoOa11 = db.Column(db.String)
    geoLsoa11 = db.Column(db.String)
...
class Postcode(db.Model, ModelWithUpsert):
    ...
    oa11 = db.Column(db.String)
    lsoa11 = db.Column(db.String)
