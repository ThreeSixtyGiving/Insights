            ...
            html.Section(
                ...
                children=[
                    ...
                    html.Div([
                        ...
                        html.Ul([
                            html.Li([html.A(
                                'external organisation identifiers, like charity numbers', href='http://standard.threesixtygiving.org/en/latest/identifiers/#id2')]),
                            html.Li(
                                [html.A('postcodes or other geo data', href='https://postcodes.findthatcharity.uk/')]),
                        ]),
                    ], id="what-next-missing"),
                    html.P([
...
@app.callback(Output('what-next-missing', 'children'),
              [Input('output-data-id', 'data')])
